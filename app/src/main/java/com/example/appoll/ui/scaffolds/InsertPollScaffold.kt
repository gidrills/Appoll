...
import com.example.appoll.ui.appbars.InsertOptionPollTopBar
import com.example.appoll.ui.appbars.InsertPollTopBar
import com.example.appoll.ui.screens.createpollscreens.InsertPollInfoScreen

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun InsertPollScaffold(modifier: Modifier, navController: NavHostController) {
    ...
    Scaffold (
        ...
        InsertPollInfoScreen(modifier = modifier.padding(it),
            isNextArrowActive,
